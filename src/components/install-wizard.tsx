...
import { CheckCircle2, Database, ShieldCheck, Loader2, Server, ArrowRight, Save, Rocket, Globe, Type, User } from 'lucide-react';
                ...
                <Card className="bg-slate-900 border-slate-800 shadow-2xl overflow-hidden">
                    ...
                    {step === 1 && (
                        <>
                            ...
                            <CardFooter>
                                <Button className="w-full" disabled={dbStatus !== 'success'} onClick={() => setStep(2)}>
                    ...
                    {step === 2 && (
                        <>
                            ...
                            <CardFooter>
                                <Button className="w-full" disabled={importStatus !== 'done'} onClick={() => setStep(3)}>
